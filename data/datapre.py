...
grouped_df = df.groupby('location')['total_cases', 'total_deaths', 'total_tests', 'total_vaccinations', 'people_vaccinated', 'people_fully_vaccinated', 'total_boosters', 'iso_code', 'continent'].sum()
